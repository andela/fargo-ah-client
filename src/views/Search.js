...
import {
  Pagination, Icon, Message, Loader,
...
export class Search extends Component {
  ...
  render() {
    ...
    const { history, history: { location }, currentUser } = this.props;
    return (
      <div>
        <Header history={history} text="Home" user={currentUser} pathname={location.pathname} />
