...
export class EditProfile extends React.Component {
  ...
  componentDidMount = () => {
    ...
    if (detail) this.setState({ image: { ...image, path: detail.image } });
  ...
  onImageChange = (e) => {
   ...
   // initializing fileinput, a placeholder for image dialog element
   fileInput = new File(['file name'], 'fargo.png', { type: 'image/png' });
